-- =============================================
-- MASTER ORCHESTRATOR RPC v3 (Full Governance)
-- Purpose: Includes lifecycle_stage and autonomy_level (L1-L5)
-- Version: v3
-- =============================================

CREATE OR REPLACE FUNCTION n8n_orchestrator_v3(
...
BEGIN
    ...
    SELECT id, tenant_id, status, max_concurrency, brain_config, lifecycle_stage::VARCHAR, autonomy_level
    INTO v_agent_id, v_tenant_id, v_agent_status, v_max_concurrency, v_agent_config, v_lifecycle_stage, v_autonomy_level
    FROM agents
...
GRANT EXECUTE ON FUNCTION n8n_orchestrator_v3(TEXT, TEXT, TEXT, JSONB) TO authenticated;
GRANT EXECUTE ON FUNCTION n8n_orchestrator_v3(TEXT, TEXT, TEXT, JSONB) TO service_role;
