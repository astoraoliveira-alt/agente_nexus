...
-- Versão 49 - THE STATE RESTORER (V43 STATE + GREETING)  --
-- ======================================================== --

-- [1] PURGE PREVIOUS FUNCTIONS
DO $$
DECLARE
    r RECORD;
BEGIN
    FOR r IN (
        ...
        WHERE p.proname IN ('fn_get_agent_context', 'fn_fetch_next_inbound_message') 
...
-- [3] MEGA FUNCTION: fn_get_agent_context (V49 Mirror)
