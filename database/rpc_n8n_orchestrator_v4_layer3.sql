-- Davos Nexus - Orchestrator V4 with Incident Risk Score Weights
-- Refined to avoid regressions and ensure justice in banning.
...
BEGIN
    ...
    IF v_agent_id IS NOT NULL THEN
        ...
        -- DAVOS RISK SCORE SYSTEM (0.3 per swear word, 3.0 to ban)
