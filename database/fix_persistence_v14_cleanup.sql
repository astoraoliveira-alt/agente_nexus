-- ========================================================================================
-- SISTEMA DE SEGURANÇA TRANSACIONAL V14 (RESOLUÇÃO DE CONFLITO PGRST203)
-- ========================================================================================

-- 1. LIMPEZA AGRESSIVA DE TODAS AS ASSINATURAS EXISTENTES
-- O erro PGRST203 acontece porque criamos a versão "text" mas a antiga "uuid" ou "varchar" ainda estava lá.
-- Este bloco vai limpar todas as possibilidades para deixar apenas UMA função limpa.
DROP FUNCTION IF EXISTS public.mock_validate_identity(uuid, uuid, text);
DROP FUNCTION IF EXISTS public.mock_validate_identity(uuid, uuid, varchar);
...
-- 2. AVALIADOR DE SEGURANÇA: O Portão Absoluto
...
-- 3. VALIDADOR DE IDENTIDADE: Assinatura ÚNICA (Resolve Conflito N8N)
