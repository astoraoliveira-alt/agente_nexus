-- ==========================================================
-- Migration: Prevent campaign re-engagement for converted leads (Production version)
-- Date: 2026-05-27
-- Description: Updates get_next_leads_secure to check success criteria and explicitly exclude already converted contacts, preserving capping, logs pressure, and full metadata return.
-- ==========================================================
