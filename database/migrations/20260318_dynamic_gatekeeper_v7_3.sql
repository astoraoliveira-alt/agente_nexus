-- Correção de Estrutura de Retorno para n8n (Remapeamento Definitivo v7_3)
...
BEGIN
    ...
    SELECT id, reopened INTO v_conversation_id, v_reopened FROM public.conversations 
    ...
    -- 5. BUSCA DE SUB-AGENTES (Com SUAS próprias Tools e Prompts)
    SELECT jsonb_agg(
        jsonb_build_object(
            'id', a.id,
            'name', a.name,
    ...
    -- 7. BUSCA DE FERRAMENTAS EXCLUSIVAS DO PAI (Gerais não associadas ou específicas do pai)
