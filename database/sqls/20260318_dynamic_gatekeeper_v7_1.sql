-- Correção de Estrutura de Retorno para n8n (Remapeamento v7)
-- Adiciona os campos faltantes 'security', 'sub_agents' e 'userPromptTemplate' para retrocompatibilidade com n8n
...
BEGIN
    ...
    -- BUSCA DE SUB-AGENTES (Para evitar nulidade no n8n)
    ...
    -- 8. RETORNO CONSOLIDADO (Retrocompatível com V6 do Workflow n8n)
    RETURN jsonb_build_object(
        ...
        'agent', jsonb_build_object(
            ...
            'userPromptTemplate', v_agent_config->>'userPromptTemplate', -- FIELD ADICIONADO
            ...
            'sub_agents', COALESCE(v_sub_agents, '[]'::jsonb), -- FIELD ADICIONADO
        ...
        'security', jsonb_build_object(    -- BLOCO TOTALMENTE RESTAURADO PARA NÃO QUEBRAR O N8N
            'session_status', COALESCE(v_session_status, 'unauthenticated'),
            'session_identifier', v_session_identifier,
