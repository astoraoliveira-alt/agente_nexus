-- FIX V10: Robust Payload Extraction (Hybrid Path)
-- Purpose: Handle both VAPI standard structure (message -> call) and user's observed structure (root -> call)
-- Also fixes message extraction path if 'artifact' is missing (fallback to root artifact)
