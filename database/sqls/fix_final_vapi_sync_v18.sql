-- =============================================
-- FIX V18: Robust Payload Extraction for VAPI
-- Purpose:
-- 1. Prevent silent fails on missing `costBreakdown.llm` objects.
-- 2. Handle null prompt tokens safely without casting errors.
-- =============================================
