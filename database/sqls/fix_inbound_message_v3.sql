-- ======================================================== --
-- DAVOS NEXUS - FIX RPC EXACT PAYLOAD                     --
-- Aplicando APENAS a injeção do Lead no Prompt (CNPJ)     --
-- ======================================================== --
...
DECLARE
    ...
    -- Variáveis adicionadas para o Prompt Injection Dinâmico:
...
BEGIN
    ...
    -- [E] Busca Histórico (CORRIGIDO: sender_type e ordenação cronológica)
    SELECT jsonb_agg(h) INTO v_history FROM (
        ...
        FROM (
            ...
            -- Sugestão de performance mantida em 10, de acordo com o original.
            LIMIT 10
        ) sub
    ...
    -- [I] CONSTRUÇÃO DO RETORNO (messages_history atualizado)
    v_retorno := jsonb_build_object(
        ...
        'agent', jsonb_build_object(
            ...
            'brain_config', v_mod_brain_config, -- <--- PROMPT DINÂMICO USADO AQUI!
