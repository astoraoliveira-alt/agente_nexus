...
-- Descrição: Agrega as métricas do Funil Executivo de Crédito
-- Bloco 1: Envio da Campanha (Carregados, Enviados, Entregues, Lidas, Interagiram)
-- Bloco 2: Funil de Venda (Faturamento, Valor Inicial, Opt-in, Aprovados, Recusados, Simularam, OK Agente)
-- Bloco 3: Funil de Formalização (Aguar. Contato, Em atendimento, Formalizado)
-- ============================================================
